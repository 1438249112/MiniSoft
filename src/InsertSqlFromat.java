...
public class InsertSqlFromat {
  ...
  public static void main(String[] args) throws Exception {
      //1.read from clipboard
		...
		String result = "insert into "+tableName+" "+fieldProcess.getFiledsString() +" values " + fieldProcess.getValuesString() ;
...
static class FieldProcess{
	...
	public FieldProcess(ArrayList<String>/*field*/ fieldNames ) {
