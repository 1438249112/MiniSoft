...
public class InsertSqlMappingFromat {
  ...
  public static void main(String[] args) throws Exception {
      //1.read from clipboard
		...
		String result = "";
			...
			FieldProcess fieldProcess = new FieldProcess(fieldNames);
			
			 result = "insert into "+tableName+" "+fieldProcess.getFiledsString() +" values " + fieldProcess.getValuesString() ;
...
static class FieldProcess{
    ...
    private  String  mappingChars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
    private String valuesString = "";
    private String filedsString = "";
	public FieldProcess(ArrayList<String>/*field*/ fieldNames ) throws Exception {
		
	
		for (int i = 0; i < fieldNames.size(); i++) {
			
			valuesString +=":"+getMappingResult(mappingChars,i)+",";
			filedsString +=fieldNames.get(i)+",";
		}
		
		valuesString ="("+ valuesString.substring(0, valuesString.length()-1)+")";
		filedsString ="("+  filedsString.substring(0, filedsString.length()-1)+")";
	}
	private String getMappingResult(String mappingChars2, int i) {
